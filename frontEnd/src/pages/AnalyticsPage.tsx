...
import { Session, CognitivePath } from '../types';
import {
  BarChart3,
  TrendingUp,
  Clock,
...
export default function AnalyticsPage() {
  ...
  const weeklyActivity = [
    ...
    { day: 'Mar', sessions: 2, interactions: 18 },
    { day: 'Mié', sessions: 4, interactions: 32 },
    { day: 'Jue', sessions: 1, interactions: 8 },
    { day: 'Vie', sessions: 5, interactions: 45 },
    { day: 'Sáb', sessions: 2, interactions: 15 },
    { day: 'Dom', sessions: 0, interactions: 0 }
  ];

  const maxInteractions = Math.max(...weeklyActivity.map(d => d.interactions));
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 rounded-xl bg-[var(--bg-card)]/50 backdrop-blur-sm">
                ...
                <p className="text-xs text-[var(--text-muted)]">Viernes con 45 interacciones</p>
              </div>
              <div className="p-4 rounded-xl bg-[var(--bg-card)]/50 backdrop-blur-sm">
                <p className="text-sm font-medium text-[var(--text-primary)] mb-1">Modo favorito</p>
                <p className="text-xs text-[var(--text-muted)]">Tutor IA ({sessionsByMode.TUTOR} sesiones)</p>
              </div>
              <div className="p-4 rounded-xl bg-[var(--bg-card)]/50 backdrop-blur-sm">
                <p className="text-sm font-medium text-[var(--text-primary)] mb-1">Racha actual</p>
                <p className="text-xs text-[var(--text-muted)]">3 días consecutivos 🔥</p>
              </div>
            </div>
          </div>
        </div>
