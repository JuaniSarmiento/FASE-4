...
@router.get(
    ...
    description="Get comprehensive report for a specific activity (Frontend compatibility)",
)
...
@router.get(
    ...
    description="Get learning analytics for a time period (Frontend compatibility)",
)
