...
@router.post(
    ...
    description="Verifica que un proveedor LLM esté configurado correctamente y responda"
)
...
@router.get(
    ...
    description="Obtiene métricas generales del sistema para el panel de administración"
)
...
@router.get(
    ...
    description="Muestra la configuración actual de LLM con API keys redactadas para debug"
)
async def get_debug_config() -> APIResponse[Dict[str, Any]]:
    """
